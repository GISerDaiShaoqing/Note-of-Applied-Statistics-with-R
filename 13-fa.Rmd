...
```{r echo=FALSE, out.width = '60%', out.height = '35%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig39.jpg")
```

基于自编函数，3个因子。

```{r echo=FALSE, out.width = '20%', out.height = '40%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig40.jpg")
```

基于fa函数，3个因子

```{r echo=FALSE, out.width = '60%', out.height = '40%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig41.jpg")
```
