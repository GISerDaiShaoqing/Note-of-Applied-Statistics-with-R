...
knitr::include_graphics("fig/fig22.jpg")
```
...
knitr::include_graphics("fig/fig23.jpg")
```

```{r echo=FALSE, out.width = '80%', out.height = '30%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig24.jpg")
```
...
```{r echo=FALSE, out.width = '100%', out.height = '25%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig25.jpg")
```

```{r eval=FALSE, echo = T}
dist.pm25<-dist(airnew[,-1],method='euclidean')
heatmap(as.matrix(dist.pm25),labRow=stationname)
```
...
knitr::include_graphics("fig/fig26.jpg")
```
...
```{r echo=FALSE, out.width = '100%', out.height = '40%', message=FALSE, warning=FALSE}
knitr::include_graphics("fig/fig27.jpg")
```
...
#preprocessing data
aqidata<-read.csv("https://github.com/GISerDaiShaoqing/Note-of-Applied-Statistics-with-R/raw/master/Appendix/Data/air20170607.csv",header=T)
...
stationlocation<-read.table("https://github.com/GISerDaiShaoqing/Note-of-Applied-Statistics-with-R/raw/master/Appendix/Data/station.txt",header=T,sep=",")
